// src/components/RegisterForm.jsx - User registration interface
 ...
 * RegisterForm
 * Props:
 *   onToggleForm - callback function to switch back to login view
 */
  ...
  return (
    <div className="w-full max-w-md p-8 rounded-2xl glass border border-white/10 shadow-2xl shadow-black/60 relative overflow-hidden animate-fade-in">
      ...
      <div className="text-center mb-8 relative">
        ...
        <h2 className="text-2xl font-extrabold text-white leading-tight">Get Started</h2>
        <p className="text-xs text-slate-400 mt-1.5">Create your free photo gallery account</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5 relative">
        ...
        {/* Name Field */}
        <div>
          <label className="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2" htmlFor="register-name">
            Full Name
          </label>
          <input
            id="register-name"
        ...
        {/* Email Field */}
        <div>
          <label className="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2" htmlFor="register-email">
            Email Address
          </label>
          <input
            id="register-email"
        ...
        {/* Password Field */}
        <div>
          <label className="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2" htmlFor="register-password">
            Password
          </label>
          <input
